...
Descriptions of data in the individual `Data` folders, following the [TIER 4.0 protocol](https://www.projecttier.org/tier-protocol/protocol-4-0/).
...
### List of collaboratos:
- Jerzy Baranowski, prof. dr hab. inż.
- Paweł Piątek, dr hab. inż.
